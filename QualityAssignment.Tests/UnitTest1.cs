...
namespace Tests
{
    public class RectangleTests
    {
        ...
        [Test]
        public void GetLength_RetrivingLength_ReturnsFalse()
        {
            //Arrange
            var rectangle = new Rectangle();
        ...
        [Test]
        public void SetLength_LoadLength_ReturnsFalse()
        {
            //Arrange
            var rectangle = new Rectangle();

            //Act
            rectangle.SetLength(55);
            var result = rectangle.GetLength();

            //Assert
            Assert.AreNotEqual(result, 55);
        }

        [Test]
        public void GetWidth_RetrivingWidth_ReturnsFalse()
        {
            //Arrange
            var rectangle = new Rectangle();
        ...
        [Test]
        public void SetWidth_LoadWidth_ReturnsFalse()
        {
            //Arrange
            var rectangle = new Rectangle();
        ...
        [Test]
        public void GetPerimeter_RetrivePerimeter_ReturnsFalse()
        {
            //Arrange
            var rectangle = new Rectangle();
            ...
            //Assert
            Assert.AreNotEqual(result, 130);
        }

        [Test]
        public void GetArea_RetriveArea_ReturnsFalse()
        {
            //Arrange
            var rectangle = new Rectangle();
